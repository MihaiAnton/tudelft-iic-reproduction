...
from src.utils.semisup.general import get_dlen, assess_acc_block
from src.utils.cluster.transforms import sobel_process, \
    sobel_make_transforms
from src.utils.cluster.general import update_lr
from src.archs.semisup.sup_head5 import SupHead5
...
def main():
    ...
    for e_i in range(start_epoch, config.num_epochs):
        ...
        for i, (imgs, targets) in enumerate(train_loader):
            imgs = sobel_process(imgs, old_config.include_rgb)
            targets = targets
