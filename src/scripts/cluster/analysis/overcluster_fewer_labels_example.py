...
from src.utils.cluster.data import make_STL_data, make_CIFAR_data
from src.utils.cluster.transforms import \
...
for pc in new_assign_set_szs_pc:
    ...
    if config.dataset == "STL10":
        dataloaders, mapping_assignment_dataloader, mapping_test_dataloader = \
            make_STL_data(config, tf1, tf2, tf3,
                          truncate_assign=True, truncate_pc=pc)
