...
from src.utils.segmentation.baselines.doersch_utils import \
    doersch_set_patches, doersch_loss
from src.utils.segmentation.baselines.kmeans_segmentation_eval import \
...
crossent = torch.nn.CrossEntropyLoss(reduction="none")
