...
# export CUDA_VISIBLE_DEVICES=3 && nohup python -m src.scripts.segmentation.analysis.render_potsdam --model_ind 738 --net_name best.pytorch > out/gnodec4_render_738.out &
...
def filter_gt_and_store(config, img_ind, gt, rescale, rerescale, colour_map,
    ...
    Image.fromarray(recoloured).save(
        os.path.join(out_dir, "%d_gt.png" % img_ind))
