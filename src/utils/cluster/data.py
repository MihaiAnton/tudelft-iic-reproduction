...
def create_basic_clustering_dataloaders(config):
    """
    My original data loading src is complex to cover all my experiments. Here is a simple version.
    ...
    dataset_head_B = torchvision.datasets.ImageFolder(
        root=train_data_path, transform=tf1),
    ...
    dataset_head_A = torchvision.datasets.ImageFolder(
        root=train_data_path, transform=tf1)
    ...
    if os.path.exists(test_data_path):
        ...
        mapping_test_dataset = torchvision.datasets.ImageFolder(
            test_data_path, transform=tf3)
