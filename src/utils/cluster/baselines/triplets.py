...
from src.utils.cluster.data import _cifar100_to_cifar20, \
    _create_dataloaders, _create_mapping_loader
from src.utils.cluster.eval_metrics import _hungarian_match, _acc
...
def triplets_get_data_kmeans_on_features(config, net, dataloader, sobel):
    ...
    flat_preds_all = torch.from_numpy(kmeans.labels_)
