...
def cluster_subheads_eval(config, net,
    ...
    print("Cluster eval 1 ", datetime.now())
    ...
    print("Cluster eval 2 ", datetime.now())
    ...
    if config.mode == "IID":
        ...
        print("Cluster eval 3.4 ", datetime.now())
    else:
        assert (False)
